...
#pragma warning restore 649
        ...
        public static Action<Transform> onChangeRotate;
        ...
        {
            rotationX += _rotationX.Update(RotationXRaw, rotationSmoothness);
            transform.rotation = Quaternion.Euler(0, rotationX, 0);
            arms.transform.rotation = Quaternion.Euler(0, rotationX, 0);
            onChangeRotate?.Invoke(arms);
        }
        ...
        {
            var direction = new Vector3(input.Move, 0f, input.Strafe);
        ...
        private class FpsInput
        {
            ...
            public float Move
            {
                get { return (joystickMove.Horizontal != 0) ? joystickMove.Horizontal : Input.GetAxisRaw(move); }
            }

            /// Returns the value of the virtual axis mapped to move the character left and right.         
            public float Strafe
            {
                get { return (joystickMove.Vertical != 0) ? joystickMove.Vertical : Input.GetAxisRaw(strafe); }
            }
