...
public class AxisController : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    /// <summary>
    ///  Метод срабатывающий при нажатии на джойстик
    /// </summary>
    ...
    /// <summary>
    /// Метод срабатывающий при отпуска джойстика
    /// </summary>
    /// <param name="eventData"></param>
    ...
    /// <summary>
    /// Метод срабатыващий при перетаскивании джойстика
    /// </summary>
    /// <param name="eventData"></param>
